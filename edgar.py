#!/usr/bin/env python3
"""
edgar.py — SEC filings as a sector-tagged language corpus.

WHY THIS MIGHT MATTER MORE THAN NEWS

Every SEC filer carries an SEC-assigned SIC industry code, and full-text search
reaches back to 2001. That is the Chorus premise in a purer form: which
...
The SEC asks that automated requests identify a contact address. Set it:
    ...
    EDGAR_UA="chorus-research you@example.com"
"""
...
def get(url, timeout=40):
    if not UA:
        raise RuntimeError(
            ...
            "themselves, e.g. EDGAR_UA=\"chorus-research you@example.com\"")
...
def main():
    ...
    print("  real structure. Nothing else in Chorus depends on this file.")
    print("=" * 64 + "\n")
