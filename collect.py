...
# "data centre" and "data center" are one phrase counted twice, which halves
# the evidence for both and can hide a spread entirely. Normalise to one form.
# American spelling is the default because most of the corpus is US trade press.
BRITISH = {
