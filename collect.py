...
COOC_DAYS    = 21        # co-occurrence is only ever shown for recent windows —
                         # a fortnight against the fortnight before it, so three
                         # weeks of daily rows is already more than is read
COOC_KEEP_PER_GRAM = 12  # partners retained per phrase per day; the rest are
