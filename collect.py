...
def write_digest(terms, path, stored, days_held):
    ...
    L += ["---", "",
          ...
          "and when each sector started using them. It makes no forecast and reports "
          "only what has already been written. \"Rising\" describes the last "
          "fortnight, not the next one.", "",
          "crosstalkwire.com"]
