...
def build(conn):
    ...
    for gram in candidates:
        ...
        out.append({
            ...
            # the window edge is not a beginning: if the earliest sighting
            # sits on it, the phrase was already in use and nobody picked it
            # up within a week of anyone
            "pace": ("simultaneous" if adoption_span is not None
                     and adoption_span <= 7
                     and firsts and firsts[0] > add_days(window_start, 2)
